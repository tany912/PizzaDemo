...
addCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var pizza = JSON.parse(btn.dataset.details);
    updateCart(pizza);
  });
...
function updateStatus(order) {
  ...
  statuses.forEach(function (status) {
    var dataProp = status.dataset.status; //for by default order i.e order_placed
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return Object(_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_1__["loadStripe"])('pk_test_51ItUosSEubgWl14bxrt4RBC8C0Se1nWVQVZxNW0JRQh19niuAByRz27YHss8z9HET28FYs7bHgU0L8P0UG3xnWKj00TqDZdt7n');
...
__webpack_require__(/*! D:\PizzaApp\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! D:\PizzaApp\resources\scss\app.scss */"./resources/scss/app.scss");
